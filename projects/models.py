...
from users.models import Profile, Special
import uuid
from django.utils.text import slugify

STATUS_CHOICES = ((0,"Практика"), (1,"Стажировка"), (2,"Вакансия"))
...
class Project(models.Model):
    ...
    kind_of_job = models.IntegerField(choices=STATUS_CHOICES, default=0)
    specialnost = models.ForeignKey(
        Special, null=True, blank=True, on_delete=models.CASCADE)
